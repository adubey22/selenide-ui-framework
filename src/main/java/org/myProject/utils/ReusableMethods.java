...
public class ReusableMethods {
    ...
    public static String getBase64Image() {
        String base64Image = "data:image/png;base64," + ((TakesScreenshot) getWebDriver()).getScreenshotAs(OutputType.BASE64);
        return base64Image;
    ...
    public static void countRows(List<SelenideElement> elementList, String rowBelongsTo){
